  ...
  head: () => ({
    meta: [
      { title: "Livres et publications — Joyanot AMOUZOUN" },
      {
        name: "description",
        content:
          "Guides professionnels, ebooks et ouvrages de M. Joyanot AMOUZOUN, disponibles au téléchargement ou à l'achat.",
      },
  ...
  return (
    <>
      <CmsPageHero
        ...
        title={t({
          fr: "Livres, guides et ressources professionnelles",
          en: "Books, guides and professional resources",
        })}
        description={t({
