  ...
  head: () => ({
    meta: [
      { title: "Actualités — Joyanot AMOUZOUN" },
      {
        name: "description",
        content:
          "Articles, prises de position et informations sur l'artisanat, l'industrie et la vie du quartier Agla.",
      },
      { property: "og:title", content: "Actualités — Joyanot AMOUZOUN" },
      {
        property: "og:description",
        content: "Articles et actualités du secteur artisanal et industriel.",
      },
  ...
  return (
    <>
      <CmsPageHero
        ...
        title={t({
          fr: "Articles, tribunes et informations",
          en: "Articles, opinion pieces and updates",
        })}
        description={t({
