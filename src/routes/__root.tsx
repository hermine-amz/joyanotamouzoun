  ...
  head: () => ({
    meta: [
      ...
      { title: "Joyanot AMOUZOUN — Ingénieur & leader de l'artisanat béninois" },
      {
        name: "description",
        content:
          "Site officiel de M. Joyanot AMOUZOUN : parcours, organisations, publications, formations et réalisations.",
      },
      { name: "author", content: "Joyanot AMOUZOUN" },
      { property: "og:site_name", content: "Joyanot AMOUZOUN" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          jobTitle: "Ingénieur mécanicien, leader de l'artisanat",
          nationality: "Bénin",
